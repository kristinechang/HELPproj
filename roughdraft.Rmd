...
# I’m not sure what you’ve included for the “new” part yet.  Did I miss something?  You did run cox.zph, but you haven’t described what is going on.  Also, I noticed that there is a plot(cox.zph(…) ) function.  What does it do?  Does it help you understand what is going on?  (I’m still sleuthing the difference between the ln(-ln(S(t))) plot and cox.zph opposite results.)
